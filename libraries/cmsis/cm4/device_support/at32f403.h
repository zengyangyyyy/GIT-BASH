...
/**
  ...
  */
    ...
    !defined (AT32F403RCT6) && !defined (AT32F403RET6) && !defined (AT32F403RGT6) && \
    !defined (AT32F403VCT6) && !defined (AT32F403VET6) && !defined (AT32F403VGT6) && \
    !defined (AT32F403ZCT6) && !defined (AT32F403ZET6) && !defined (AT32F403ZGT6) && \
    !defined (AT32F403CCU6) && !defined (AT32F403CEU6) && !defined (AT32F403CGU6)

    #error "Please select first the target device used in your application (in at32f403.h file)"
#endif
...
/**
  * @brief at32f403 standard peripheral library version number
  */
...
#define __AT32F403_LIBRARY_VERSION          ((__AT32F403_LIBRARY_VERSION_MAJOR << 24)  | \
                                             ...
                                             (__AT32F403_LIBRARY_VERSION_MINOR << 8)   | \
                                             (__AT32F403_LIBRARY_VERSION_RC))
...
/**
  * @brief at32f403 interrupt number definition, according to the selected device
