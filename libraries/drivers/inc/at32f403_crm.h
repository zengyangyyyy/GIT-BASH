...
#ifndef __AT32F403_CRM_H
#define __AT32F403_CRM_H
...
typedef enum
{
  ...
  CRM_GPIOG_PERIPH_CLOCK                 = MAKE_VALUE(0x18, 8),  /*!< gpiog periph clock */
  ...
  CRM_I2C3_PERIPH_CLOCK                  = MAKE_VALUE(0x1C, 26), /*!< i2c3 periph clock */
...
typedef enum
{
  ...
  CRM_GPIOG_PERIPH_RESET                 = MAKE_VALUE(0x0C, 8),  /*!< gpiog periph reset */
  ...
  CRM_I2C3_PERIPH_RESET                  = MAKE_VALUE(0x10, 26), /*!< i2c3 periph reset */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 2; /* [18:17] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved3            : 7; /* [27:25] */
    } misc1_bit;
  };
