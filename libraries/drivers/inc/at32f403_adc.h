/**
  **************************************************************************
  * @file     at32f403_adc.h
  * @brief    at32f403 adc header file
  **************************************************************************
...
#ifndef __AT32F403_ADC_H
#define __AT32F403_ADC_H
...
typedef enum
{
  ...
  ADC_ORDINARY_LONGSHIFT_ONLY_MODE          = 0x08, /*!< ordinary long shifting mode only */
  ADC_PREEMPT_INTERLTRIG_ONLY_MODE          = 0x09  /*!< preempt interleaved trigger mode only */
...
typedef enum
{
  ...
  ADC12_ORDINARY_TRIG_TMR15CH1           = 0x08, /*!< timer15 ch1 event as trigger source of adc1/adc2 ordinary sequence */
  ADC12_ORDINARY_TRIG_TMR15CH2           = 0x09, /*!< timer15 ch2 event as trigger source of adc1/adc2 ordinary sequence */
  ADC12_ORDINARY_TRIG_TMR15CH3           = 0x0A, /*!< timer15 ch3 event as trigger source of adc1/adc2 ordinary sequence */
  ADC12_ORDINARY_TRIG_TMR15CH4           = 0x0B, /*!< timer15 ch4 event as trigger source of adc1/adc2 ordinary sequence */
  ADC12_ORDINARY_TRIG_TMR15TRGOUT        = 0x0C, /*!< timer15 trgout event as trigger source of adc1/adc2 ordinary sequence */
  ...
  ADC3_ORDINARY_TRIG_TMR15CH1            = 0x08, /*!< timer15 ch1 event as trigger source of adc3 ordinary sequence */
  ADC3_ORDINARY_TRIG_TMR15CH2            = 0x09, /*!< timer15 ch2 event as trigger source of adc3 ordinary sequence */
  ADC3_ORDINARY_TRIG_TMR15CH3            = 0x0A, /*!< timer15 ch3 event as trigger source of adc3 ordinary sequence */
  ADC3_ORDINARY_TRIG_TMR15CH4            = 0x0B, /*!< timer15 ch4 event as trigger source of adc3 ordinary sequence */
  ADC3_ORDINARY_TRIG_TMR15TRGOUT         = 0x0C, /*!< timer15 trgout event as trigger source of adc3 ordinary sequence */
...
typedef enum
{
  ...
  ADC12_PREEMPT_TRIG_TMR15CH1            = 0x08, /*!< timer15 ch1 event as trigger source of adc1/adc2 preempt sequence */
  ADC12_PREEMPT_TRIG_TMR15CH2            = 0x09, /*!< timer15 ch2 event as trigger source of adc1/adc2 preempt sequence */
  ADC12_PREEMPT_TRIG_TMR15CH3            = 0x0A, /*!< timer15 ch3 event as trigger source of adc1/adc2 preempt sequence */
  ADC12_PREEMPT_TRIG_TMR15CH4            = 0x0B, /*!< timer15 ch4 event as trigger source of adc1/adc2 preempt sequence */
  ADC12_PREEMPT_TRIG_TMR15TRGOUT         = 0x0C, /*!< timer15 trgout event as trigger source of adc1/adc2 preempt sequence */
  ...
  ADC3_PREEMPT_TRIG_TMR15CH1             = 0x08, /*!< timer15 ch1 event as trigger source of adc3 preempt sequence */
  ADC3_PREEMPT_TRIG_TMR15CH2             = 0x09, /*!< timer15 ch2 event as trigger source of adc3 preempt sequence */
  ADC3_PREEMPT_TRIG_TMR15CH3             = 0x0A, /*!< timer15 ch3 event as trigger source of adc3 preempt sequence */
  ADC3_PREEMPT_TRIG_TMR15CH4             = 0x0B, /*!< timer15 ch4 event as trigger source of adc3 preempt sequence */
  ADC3_PREEMPT_TRIG_TMR15TRGOUT          = 0x0C, /*!< timer15 trgout event as trigger source of adc3 preempt sequence */
